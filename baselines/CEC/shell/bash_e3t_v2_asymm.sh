...
# # asymm_advantages_9
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=0 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=1 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=2 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=3 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=4 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
python baselines/CEC/e3t.py ENV_KWARGS.layout=asymm_advantages_9 SEED=5 WANDB_MODE=online PROJECT=crossenv_baseline_v2 NUM_ENVS=64
