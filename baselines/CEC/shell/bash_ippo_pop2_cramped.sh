...
# cramped_room_9
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=0 WANDB_MODE=online PROJECT=crossenv_baseline_v2
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=1 WANDB_MODE=online PROJECT=crossenv_baseline_v2
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=2 WANDB_MODE=online PROJECT=crossenv_baseline_v2
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=3 WANDB_MODE=online PROJECT=crossenv_baseline_v2
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=4 WANDB_MODE=online PROJECT=crossenv_baseline_v2
python baselines/CEC/ippo_general_population_v2.py ENV_KWARGS.layout=cramped_room_9 SEED=5 WANDB_MODE=online PROJECT=crossenv_baseline_v2
