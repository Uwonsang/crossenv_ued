...
@hydra.main(version_base=None, config_path="config", config_name="ippo_overcooked_CEC_dual_destination_popart")
def main(config):
    ...
    ckpt_group = "cec_popart" if config["ENV_KWARGS"]["random_reset"] else "ippo_popart"
